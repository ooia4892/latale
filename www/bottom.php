...
<?php if(!$mainPage){ ?>
  ...
  <div class="aside" style='float:right; width:240px; background-color: #2f3238'>
    <div class="side_inner">
      <div id="sp_login"><a href="#a">로그인</a></div>
      <div class="s_lg_link">
        <span><a href="#a">회원가입</a></span>
        <span><a href="#a">아이디</a></span>·<span><a href="#a">비밀번호 찾기</a></span>
      </div>
      <div class="s_pc">
        <span><a href="#a">PC방</a></span>
        <span><a href="#a">PC방 혜택보기</a></span>
      </div>
    </div>
        ...
        <h2 id="tit_sub"><a href="#a">커뮤니티</a></h2>
          <nav>
            <ul>
              ...
              <li><a href="#a">공략 게시판</a></li>
              <li><a href="#a">거래 게시판</a></li>
              <li><a href="#a">유저 갤러리</a></li>
            </ul>
          </nav>
      </div>
    </div>
    ...
    <div id="sp_banner_wrap">
      <ul>
        <li><a href="#a"><div class="sp_banner01">dsgsdgsgdsgsgds</div></a></li>
        <li><a href="#a"><div class="sp_banner02"></div></a></li>
      </ul>
    </div>
