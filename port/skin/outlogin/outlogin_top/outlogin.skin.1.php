...
<!-- <li>
	...
	<a href="#" id="outlogin_wrap_open_htop">
...
<!-- 로그인 전 외부로그인 시작 -->
<div class="outlogin_wrap_htop">
	<div class="outlogin_bg_htop"></div>
	<div class="outlogin_wrap_area" id="layer_outlogin_htop">

		<form name="foutlogin" action="<?php echo $outlogin_action_url ?>" onsubmit="return fhead_submit(this);" method="post" autocomplete="off">
		<fieldset>
        <input type="hidden" name="url" value="<?php echo $outlogin_url ?>">
		<div id="login-box">
			<a id="outlogin_wrap_close_htop" href="#">X</a>
			...
			<div id="login-box-field" style="margin-top:34px;"><input id="mb_id" name="mb_id" type="text" class="form-login" size="30" maxlength="50" itemname="아이디" required minlength="2" onMouseOver='chkReset(this.form);' onFocus='chkReset(this.form);' placeholder="아이디" title="아이디">
				<p class="clearfix auto_h-login_wrap">
	          <input type="checkbox" name="auto_h-login" value="1" id="auto_h-login">
	          <label for="auto_h-login" id="auto_h-login_label"></label><span>ID저장</span>
				</p>
			</div>
...
<script type="text/javascript">
jQuery(function($){
	function outlogin_wrap_open_htop(el){
		//$('.outlogin_wrap').addClass('open');
		$('.outlogin_wrap_htop').fadeIn();
		var temp = $('#' + el);
	...
	$('#outlogin_wrap_open_htop').click(function(){
		outlogin_wrap_open_htop('layer_outlogin_htop'); /* 열고자 하는 것의 아이디를 입력 */
		$("#mb_id").focus().select();
		return false;
	});
	$('.outlogin_wrap_htop .outlogin_bg_htop').click(function(){
		$('.outlogin_wrap_htop').fadeOut();
	});
	$('#outlogin_wrap_close_htop').click(function(){
		$('.outlogin_wrap_htop').fadeOut();
		return false;
	});
});
